...
#define SpinVersion	"Spin Version 6.5.2 -- 15 February 2024"
#define PanSource	"KMeansValidate.pml"
...
#define _nstates1	87	/* main */
#define minseq1	40
#define maxseq1	125
#define _endstate1	86

#define _nstates0	41	/* UpdateLabel */
#define minseq0	0
#define maxseq0	39
...
#define Air1	(sizeof(P1) - Offsetof(P1, _6_4_4_a) - 1*sizeof(int))

#define PUpdateLabel	((P0 *)_this)
typedef struct P0 { /* UpdateLabel */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, _5_2_distY) - 1*sizeof(int))
